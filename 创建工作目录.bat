...
rem Last Modified Time:2018-04-23 13:51
...
echo rem 创建时间：2018-04-23 13:01>>.\!className!\!lessonName!\Listme.bat
echo rem 最后修改时间:%Date:~0,4%-%Date:~5,2%-%Date:~8,2%>>.\!className!\!lessonName!\Listme.bat
echo cd /d %~dp0 >>.\!className!\!lessonName!\Listme.bat
echo 统计学生作业 !lessonName! !className! >>.\!className!\!lessonName!\Listme.bat
)
)
